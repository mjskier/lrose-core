...
def gitCheckout():
    ...
    shellCmd("git clone https://github.com/mjskier/lrose-core")
    # shellCmd("git clone https://github.com/NCAR/lrose-netcdf") TODO
    shellCmd("git clone https://github.com/NCAR/lrose-displays")

    # TODO Temporary
    
    # Add the python3 stuff
    # my_src = "/Users/bpmelli/devel/mjskier-lrose-core"
    # shellCmd2("ln -fs " + my_src
    #           + "/codebase/make_bin/*.py3 /tmp/lrose_build/lrose-core/codebase/make_bin")
    # shellCmd2("chmod +x /tmp/lrose_build/lrose-core/codebase/make_bin/*.py3")
    
    # shellCmd2("ln -fs " + my_src + "/build/*.py3 /tmp/lrose_build/lrose-core/build")
    # shellCmd2("chmod +x /tmp/lrose_build/lrose-core/build/*.py3")
